                            ...
                            <div className="bg-white p-6 rounded-4xl shadow w-full hover:shadow-lg cursor-pointer flex justify-between my-4">
                                <div className="flex flex-col justify-between w-full">
                                    ...
                                    <div className="flex items-end space-x-2 pb-2">
                                        {/* <span className="text-4xl md:text-5xl font-bold text-gray-9</span>00">{loading ? "Loading..." : jumlahPekerja}</span> */}
                                        ...
                                        <span className="text-2xl font-semibold text-gray-500">/ 1200 orang</span>
