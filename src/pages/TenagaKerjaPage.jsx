                        ...
                        <table className="min-w-2xl border border-gray-300">
                            <thead>
                                <tr className="bg-gray-200">
                                    ...
                                    <th className="py-2 px-4 border-b border-gray-300">Jumlah Tenaga Kerja</th>
                                </tr>
                            </thead>
                            <tbody>
                                {loading ? (
                                    ...
                                    filteredData.map((item, index) => (
                                        <tr key={index} className={`border-b border-gray-300 ${selectedRow === index ? 'bg-blue-100' : ''}`} onClick={() => setSelectedRow(index)}>
                                            ...
                                            <td className="py-2 px-4 border-b border-gray-300 text-right">{item.pekerja}</td>
                                        </tr>
                                    ))
                                )}
                            </tbody>
...
export default TenagaKerjaPage;